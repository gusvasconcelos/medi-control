...
/**
* @see \App\Http\Controllers\Api\PermissionController::grouped
* @see app/Http/Controllers/Api/PermissionController.php:76
* @route '/api/v1/permissions-grouped'
*/
export const grouped = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: grouped.url(options),
    method: 'get',
})
...
* @route '/api/v1/permissions-grouped'
*/
grouped.url = (options?: RouteQueryOptions) => {
    return grouped.definition.url + queryParams(options)
}
...
* @route '/api/v1/permissions-grouped'
*/
grouped.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: grouped.url(options),
    method: 'get',
})
...
* @route '/api/v1/permissions-grouped'
*/
grouped.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: grouped.url(options),
    method: 'head',
})

const PermissionController = { index, store, show, update, destroy, grouped }
