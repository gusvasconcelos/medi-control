...
interface UseAdherenceReportReturn {
...
export function useAdherenceReport(
    ...
    }, [dateRange.startDate, dateRange.endDate, showError]);
    ...
    }, [dateRange.startDate, dateRange.endDate, showError, showSuccess]);
