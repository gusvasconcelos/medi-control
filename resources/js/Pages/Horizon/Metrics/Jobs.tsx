...
interface HorizonMetricsJobsProps extends PageProps {
    jobs: string[];
...
export default function HorizonMetricsJobs({
    auth,
    jobs,
    selectedJob,
    snapshots,
}: HorizonMetricsJobsProps) {
    ...
    const handleJobSelect = (job: string) => {
        router.get(`${BASE_URL}/metrics/jobs`, { selected: job }, {
            preserveState: true,
            preserveScroll: true,
        });
    };
    ...
    return (
        <>
            <Head title="Métricas de Jobs - Horizon" />
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-base-content/60 mt-1">
                                        Performance e throughput por tipo de job
                                    </p>
                                </div>
                            </div>
                                ...
                                <div className="lg:col-span-1">
                                    <div className="bg-base-100 border border-base-300 rounded-2xl overflow-hidden">
                                        <div className="p-4 border-b border-base-300">
                                            <h2 className="font-semibold">Jobs Monitorados</h2>
                                        ...
                                        <div className="max-h-[500px] overflow-y-auto">
                                            {jobs.map((job) => {
                                                const shortName = job.split('\\').pop() || job;
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <span className="block text-xs text-base-content/50 truncate mt-0.5">
                                                            {job}
                                                        </span>
                                                    </button>
                                                );
                                    ...
                                    {selectedJob ? (
                                        ...
                                        <div className="bg-base-100 border border-base-300 rounded-2xl p-12 text-center">
                                            ...
                                            <p className="text-lg font-medium text-base-content/60">
                                                Selecione um job para visualizar as métricas
                                            </p>
                                        </div>
                                    )}
                                </div>
