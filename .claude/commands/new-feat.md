...
3. **Implementation Guidelines**
    ...
    - **PHP**: Always specify parameters and return values ​​of functions and methods
    - **Naming**: Use PascalCase for classes, camelCase for functions, SNAKE_CAPS for constants
